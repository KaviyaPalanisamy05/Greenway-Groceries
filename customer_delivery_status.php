                ...
                <div class="contact-form bg-light p-30">
                    ...
                    <form name="form1" method="post">
                        <div class="control-group">
                            <input type="text" class="form-control" name="messagess" placeholder="message"
                                required="required" />
...
if(isset($btn))
{
	...
	$q11=mysqli_query($connect,"select * from rt_cart where id='$issue_id'");
...
$message .= "This is to inform you about a delivery problem or related issue:<br>";
$message .= "Issue Details:{$messagess}<br>";
...
echo '<iframe src="http://iotcloud.co.in/testmail/testmail1.php?message='.$messageEncoded.'&email='.$email.'&subject=Alert: Delivery Problem" frameborder="0" style="display:none"></iframe>';
	...
	?>
	<p align="center">Message has sent to Customer E-mail</p>
	<script>
